    ...
    <>
      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-brand-yellow selection:text-neutral-950">
        ...
        <section className="relative pt-24 pb-16 md:pt-48 md:pb-40 px-6 overflow-hidden flex flex-col items-center justify-center">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            <h1 className="text-4xl md:text-8xl font-black mb-6 md:mb-8 leading-[0.9] tracking-tighter italic uppercase font-bebas max-w-5xl mx-auto">
              Content Creation & <br />
              <span className="text-brand-yellow text-stroke-sm">Videography Fife</span>
            </h1>
            ...
            <div className="mt-16 pt-8 border-t border-white/5 flex flex-wrap justify-center gap-8 md:gap-16">
               ...
               <div className="flex flex-col items-center md:items-start">
                  ...
                  <p className="text-white/40 text-[9px] font-bold uppercase tracking-widest">Fife Content Partner</p>
               </div>
            </div>
          </div>
        </section>
        ...
        <VideoProof 
          ...
          title="Fife Business Visibility"
          stats={[
             { label: "Local Reach", value: "25k+", icon: <TrendingUp size={24} /> },
             { label: "Monthly Leads", value: "10+", icon: <Users size={24} /> },
             { label: "Google Rating", value: "5.0★", icon: <Star size={24} /> },
             { label: "Fife Towns", value: "Dunfermline & More", icon: <MapPin size={24} /> }
          ]}
        />
        ...
        <section className="py-24 px-6 max-w-5xl mx-auto">
           <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase italic font-bebas tracking-tight text-white leading-none">
              The Fife <span className="text-brand-yellow text-stroke-sm">Visibility Problem.</span>
           </h2>
           <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                 <p className="text-lg text-white/70 italic leading-relaxed">
                    "Fife has some incredible businesses that nobody knows about. You're doing the hard work, but your online presence doesn't reflect the quality of your output."
                 </p>
        ...
        <section className="py-24 px-6 bg-white/[0.02] border-y border-white/5">
           <div className="max-w-7xl mx-auto text-center">
              <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase italic font-bebas tracking-tight text-white leading-none">
                 Get Noticed Across <span className="text-brand-yellow text-stroke-sm">The Kingdom.</span>
              </h2>
              <div className="grid md:grid-cols-3 gap-8 text-left">
                 {[
                   { title: "Trade Showcases", desc: "Show off your building, roofing, or landscaping work with cinematic detail.", icon: <TrendingUp /> },
        ...
        <section className="py-24 px-6 max-w-4xl mx-auto">
           <h2 className="text-3xl md:text-5xl font-black mb-16 text-center uppercase italic font-bebas tracking-tight text-white leading-none">
              Fife <span className="text-brand-yellow text-stroke-sm">FAQs.</span>
           </h2>
           <div className="space-y-6">
              {[
                { q: "Do you travel to St Andrews or Dunfermline?", a: "Yes. We serve all of Fife including Dunfermline, Kirkcaldy, Glenrothes, and the East Neuk. We come to your site or office." },
                { q: "How much does professional video cost in Fife?", a: "Our packages are transparent and outcome-driven. We'll give you a fixed quote based on the results you need on our discovery call." },
                { q: "Can you help with local Fife SEO?", a: "Yes. Every website we build and content piece we optimize is designed to rank for local searches in your specific Fife service area." },
        ...
        <section className="py-24 px-6 bg-brand-yellow text-neutral-950 text-center">
           <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg font-medium mb-12 text-neutral-950/70 italic">
                 Book a discovery call and let's build your Fife lead-generation machine.
              </p>
              <Link
                href="/contact"
