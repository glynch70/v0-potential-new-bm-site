      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-brand-yellow selection:text-neutral-950">
        ...
        <section className="py-32 px-6 max-w-5xl mx-auto text-center md:text-left">
           <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase italic font-bebas tracking-tight text-white leading-none">
              The Problem With <br /><span className="text-brand-yellow">Standard Web Design.</span>
           </h2>
           <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="p-10 rounded-[2rem] bg-neutral-900 border border-white/5 relative overflow-hidden group">
                 ...
                 <h4 className="text-xl font-black uppercase italic font-bebas tracking-widest text-brand-yellow mb-4">The Bear Media Difference</h4>
        ...
        <section className="py-32 px-6 bg-neutral-900/50 border-y border-white/5">
           <div className="max-w-7xl mx-auto text-center">
              <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase italic font-bebas tracking-tight text-white leading-none">
                 Our <span className="text-brand-yellow">Solution.</span>
              </h2>
              <div className="grid md:grid-cols-3 gap-8 text-left">
                 {[
                   { icon: <Zap className="text-brand-yellow" size={32} />, title: "Extreme Speed", desc: "Built for performance. We ensure your site loads instantly on mobile so you never lose a customer." },
                   { icon: <Target className="text-brand-yellow" size={32} />, title: "Local SEO", desc: "Optimised for West Lothian search terms to put you in front of Livingston and Bathgate buyers." },
                   { icon: <MousePointer2 className="text-brand-yellow" size={32} />, title: "Conversion First", desc: "Strategically placed CTAs and messaging designed to make your phone ring." }
                 ].map((item, i) => (
        ...
        <section className="py-32 px-6 text-center">
           <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-6xl font-black mb-8 uppercase italic font-bebas tracking-tight text-white leading-none">
                 Want more enquiries from <br /> your <span className="text-brand-yellow text-underline">website and content?</span>
              </h2>
