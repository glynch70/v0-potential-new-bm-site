      ...
      <main className="min-h-screen bg-[#0f0e0c] text-[#E8E0D5] font-inter-tight selection:bg-[#F1B92D] selection:text-[#0f0e0c] overflow-hidden">
        ...
        <div className="py-12 border-b border-white/5 bg-[#171513]/20 overflow-hidden relative flex items-center">
          ...
          <div className="flex whitespace-nowrap animate-marquee items-center gap-20 text-white/10 font-bebas tracking-[0.15em] text-xl md:text-2xl w-[200%] uppercase">
             <span>C&G Developments</span><span className="text-[#F1B92D]/30">•</span>
             <span>Simply Sheds</span><span className="text-[#F1B92D]/30">•</span>
             <span>Seamus Corry</span><span className="text-[#F1B92D]/30">•</span>
             <span>Almond Vet Care</span><span className="text-[#F1B92D]/30">•</span>
             <span>K Lewis Joinery</span><span className="text-[#F1B92D]/30">•</span>
             <span>Robertsons Transport</span><span className="text-[#F1B92D]/30">•</span>
        ...
        {/* MAIN PORTFOLIO GRID (DARK CINEMATIC) */}
        <section className="py-40 px-6 bg-[#0a0908] text-[#E8E0D5] relative z-10 border-b border-white/5">
          ...
          <div className="w-full px-6 md:px-12 lg:px-24 relative z-10">
            <div className="text-center mb-24 max-w-xl mx-auto">
               <p className="text-[#F1B92D] font-bold uppercase tracking-[0.3em] text-[12px] md:text-[13px] mb-4 font-inter-tight">The Showcase</p>
               <h2 className="text-5xl md:text-7xl font-bebas text-[#E8E0D5] tracking-wide mb-6 uppercase">REAL CASE STUDIES</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {caseStudies.map((item, idx) => (
                <motion.div
                  ...
                  className="bg-[#171513]/40 backdrop-blur-xl border border-white/5 shadow-sm rounded-sm overflow-hidden flex flex-col justify-between group hover:border-[#F1B92D]/20 transition-all"
                >
                  <Link href={item.slug} className="block relative aspect-[4/3] overflow-hidden bg-[#0f0e0c]">
                    <Image 
                      src={item.image} 
                      alt={item.name} 
                      fill 
                      className="object-cover filter contrast-[1.05] group-hover:scale-[1.02] transition-transform duration-[2.5s] ease-out opacity-80"
                    />
                  ...
                  <div className="p-8 flex flex-col justify-between flex-grow">
                    <div>
                      <span className="text-[#F1B92D] font-bold uppercase tracking-[0.2em] text-[13px] md:text-sm md:text-[12px] mb-3 block">
                        {item.category}
                      </span>
                      <h3 className="text-3xl font-bebas text-[#E8E0D5] mb-4 tracking-wider uppercase leading-none">
                        {item.name}
                      </h3>
                      ...
                      <div className="space-y-2 mb-8">
                        {item.services.map((service, i) => (
                          <div key={i} className="flex items-center gap-3">
                            <CheckCircle2 size={12} className="text-[#F1B92D] flex-shrink-0" />
                            <span className="text-[#E8E0D5]/90 text-xs font-light">{service}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="pt-6 border-t border-white/5">
                      <Link 
                        href={item.slug} 
                        className="inline-flex items-center justify-between w-full text-[12px] md:text-[13px] font-bold uppercase tracking-[0.25em] text-[#E8E0D5] hover:text-[#F1B92D] transition-colors"
                      >
        ...
        <section className="py-48 px-6 bg-[#0a0908] text-[#E8E0D5] relative z-10 border-t border-white/5 text-center flex items-center justify-center overflow-hidden">
          ...
          <div className="w-full px-6 relative z-10 flex flex-col items-center">
            ...
            <h2 className="font-bebas text-[#E8E0D5] leading-[0.9] mb-12">
              READY TO BUILD <br/><span className="text-[#E8E0D5]/25">YOUR OWN RESULTS HUB?</span>
            </h2>
            <Link
              href="/contact"
