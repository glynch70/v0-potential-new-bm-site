            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div>
                ...
                <h1 className="text-4xl md:text-7xl font-black italic uppercase font-bebas leading-[0.9] text-white">
                  C&G <span className="text-brand-yellow">Developments</span>
                </h1>
              </div>
              <div className="flex flex-col gap-2 bg-neutral-900 border border-white/10 p-4 rounded-xl">
                 ...
                 <p className="text-brand-yellow text-3xl font-black font-bebas">129,000+ Views</p>
              </div>
            </div>
          </header>
          ...
          <div className="grid md:grid-cols-3 gap-12 border-t border-white/5 pt-12">
            <div className="md:col-span-2 space-y-12">
              ...
              <section className="bg-brand-yellow/10 border border-brand-yellow/20 rounded-3xl p-8">
                ...
                <div className="grid grid-cols-2 gap-6 mb-6">
                   <div>
                      <p className="text-white/50 font-bold uppercase text-[10px] tracking-widest mb-1">Generated In 90 Days</p>
                      <p className="text-4xl font-black font-bebas text-white">129,000+ Views</p>
                   </div>
                   <div>
                      <p className="text-white/50 font-bold uppercase text-[10px] tracking-widest mb-1">Local Engagements</p>
              ...
              <section className="bg-neutral-900 border border-white/5 rounded-3xl p-8 italic relative overflow-hidden">
                 ...
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       ...
                       <p className="text-brand-yellow text-xs">C&G Developments</p>
                    </div>
                 </div>
              </section>
            ...
            <div className="space-y-8">
               ...
               <div className="bg-neutral-900/50 rounded-3xl p-8 border border-white/5 h-fit">
                 ...
                 <p className="text-white/60 text-sm italic mb-6">We help construction firms across Scotland dominate their local area.</p>
