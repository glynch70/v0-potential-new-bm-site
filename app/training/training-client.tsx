    ...
    <main className="bg-dark min-h-screen text-white font-figtree">
      ...
      <section className="relative py-32 md:py-48 px-6 overflow-hidden border-b border-white/5">
         ...
         <div className="max-w-[1240px] mx-auto text-center relative z-10">
            ...
            >
              Digital Skills <span className="text-gold">Training</span> Scotland
            </motion.h1>
      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-[1240px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-4xl md:text-6xl font-black text-white uppercase italic tracking-tighter mb-8">What is <span className="text-gold">Digital Training</span>?</h2>
            <div className="text-white text-lg md:text-xl space-y-6 leading-relaxed italic">
              ...
              <p className="text-sm border-t border-white/5 pt-8">
                Ready to put these skills into practice? We also offer <Link href="/social-media" className="text-gold hover:underline">Social Media Content Creation</Link> to handle the heavy lifting for you.
              </p>
            </div>
          </div>
          <div className="glass-card p-12 border-gold/20">
            <h3 className="text-2xl font-black text-gold uppercase italic mb-6">Why it matters</h3>
      ...
      <section className="py-24 md:py-32 px-6 bg-white/[0.02]">
        <div className="max-w-[1240px] mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-black text-white uppercase italic tracking-tighter">What we <span className="text-gold">actually</span> do</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {offerings.map((offering, index) => (
              <motion.div
                ...
                className="glass-card p-10 flex flex-col items-start border-gold/10 hover:border-gold/30 transition-all group"
              >
                <div className="w-16 h-16 rounded-full bg-gold/10 flex items-center justify-center mb-8 border border-gold/20 group-hover:bg-gold/30 transition-colors">
                  <offering.icon size={30} className="text-gold" />
                </div>
                <h3 className="text-2xl font-black text-gold uppercase italic mb-4">{offering.title}</h3>
      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-[1240px] mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-black text-white uppercase italic tracking-tighter">Simple <span className="text-gold">Pricing</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            {pricing.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gold p-12 rounded-3xl flex flex-col items-center text-center shadow-2xl relative overflow-hidden group"
              >
           ...
           >
              <div className="glass-card p-10 md:p-16 border-gold/30 text-white text-center flex flex-col items-center">
                 ...
                 <div className="flex flex-col items-center mb-12">
                    <span className="text-lg font-black uppercase tracking-tighter text-gold">Callie</span>
                    <span className="text-white font-black uppercase tracking-widest text-[13px] md:text-sm">M&M Compliance and Training Services</span>
                 </div>
                 ...
                 <a 
                   ...
                   className="bg-gold text-dark px-10 py-5 rounded-full font-black uppercase tracking-widest text-sm shadow-[0_0_30px_rgba(201,162,39,0.3)] hover:scale-105 transition-all italic"
                 >
      ...
      <section className="py-32 md:py-48 px-6 text-center border-t border-white/5">
        <div className="max-w-[1240px] mx-auto">
          <h2 className="text-5xl md:text-8xl font-black text-white italic tracking-tighter uppercase mb-12 leading-none">
            Ready to <span className="text-gold">Master</span><br />your own tools?
          </h2>
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-gold text-dark text-xl md:text-3xl font-black py-8 px-16 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-[0_20px_40px_-15px_rgba(221,163,30,0.4)] animate-[float_4s_ease-in-out_infinite] uppercase italic tracking-widest"
          >
            Book a Training Session
          </a>
          ...
          <div className="mt-24">
            <Link 
              href="/" 
              className="inline-flex items-center gap-4 text-white hover:text-gold transition-colors font-black uppercase tracking-[0.4em] text-xs"
            >
