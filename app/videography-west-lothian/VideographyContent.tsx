      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-gold selection:text-neutral-950">
        ...
        <section className="py-32 px-6 max-w-5xl mx-auto text-center md:text-left">
           <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase italic font-bebas tracking-tight text-white leading-none">
              The Problem With <br /><span className="text-gold">Static Content.</span>
           </h2>
           <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="p-10 rounded-[2rem] bg-neutral-900 border border-white/5 relative overflow-hidden group">
                 ...
                 <Link href="/video-production" className="text-white font-black uppercase italic font-bebas tracking-widest text-[13px] md:text-sm hover:text-gold transition-colors flex items-center gap-2 group">
        ...
        <section className="py-32 px-6 bg-neutral-900/50 border-y border-white/5">
           <div className="max-w-7xl mx-auto text-center">
              <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase italic font-bebas tracking-tight text-white leading-none">
                 Our <span className="text-gold">Visual Solution.</span>
              </h2>
              <div className="grid md:grid-cols-3 gap-8 text-left">
                 {[
                   { icon: <Camera className="text-gold" size={32} />, title: "Cinematic Tours", desc: "Showcase the true scale and quality of your local projects in stunning detail." },
                   { icon: <Video className="text-gold" size={32} />, title: "Drone Visuals", desc: "Breathtaking aerial coverage that sets your business apart from the competition." },
                   { icon: <Target className="text-gold" size={32} />, title: "Result Reels", desc: "Short, high-impact videos designed specifically to drive discovery and enquiries." }
                 ].map((item, i) => (
        ...
        <section className="py-32 px-6 text-center">
           <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-6xl font-black mb-8 uppercase italic font-bebas tracking-tight text-white leading-none">
                 Want more enquiries from <br /> your <span className="text-gold text-underline">video content?</span>
              </h2>
