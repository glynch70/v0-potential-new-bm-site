...
export const metadata: Metadata = {
  title: 'Voice2Lead | Corporate Coaching Website | Bear Media',
  description: 'A professional website design, SEO, and branding project for Voice2Lead, a corporate leadership coaching firm.',
  alternates: {
    canonical: 'https://bear-media.com/portfolio/voice2lead',
  },
  openGraph: {
    url: 'https://bear-media.com/portfolio/voice2lead',
    title: 'Voice2Lead | Corporate Coaching Website | Bear Media',
    description: 'A professional website design, SEO, and branding project for Voice2Lead, a corporate leadership coaching firm.',
    type: 'website',
    siteName: 'Bear Media',
...
const breadcrumbSchema_portfolio_voice2lead = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Voice2Lead",
      "item": "https://bear-media.com/portfolio/voice2lead"
    }
  ]
};
...
export default function Voice2LeadCaseStudy() {
  return (
    <>
      <Script
        id="breadcrumb-schema-portfolio-voice2lead"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema_portfolio_voice2lead) }}
      />
      <Navbar />
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div>
                ...
                <h1 className="text-4xl md:text-7xl font-black italic uppercase font-bebas leading-[0.9] text-white">
                  Voice2<span className="text-gold">Lead</span>
                </h1>
              </div>
              <a 
            ...
            <div className="md:col-span-2 space-y-8">
              <section>
                ...
                <p className="text-white/90 italic leading-relaxed text-lg mb-4">
                  Voice2Lead empowers professionals through high-level leadership and communication coaching. They needed a clean, authoritative <Link href="/web-design" className="text-gold hover:underline">website design</Link> that could immediately capture trust from corporate clients and executives.
                </p>
