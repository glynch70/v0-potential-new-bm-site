            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div>
                ...
                <h1 className="text-4xl md:text-7xl font-black italic uppercase font-bebas leading-[0.9] text-white">
                  The Free <span className="text-brand-yellow">Spirit</span>
                </h1>
              </div>
              <a 
            ...
            <div className="md:col-span-2 space-y-8">
              <section>
                ...
                <p className="text-white/70 italic leading-relaxed text-lg">
                  This involved crafting a custom <Link href="/web-design" className="text-brand-yellow hover:underline">website design</Link> and producing high-quality creative content that deeply resonates with their audience.
                </p>
              </section>
              <section>
