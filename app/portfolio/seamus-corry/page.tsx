...
export const metadata: Metadata = {
  title: 'Seamus Corry Rebrand | Personal Branding | Bear Media',
  description: 'An upcoming personal branding, website redesign, and content strategy project for Seamus Corry.',
};
        ...
        <article className="max-w-5xl mx-auto px-6 pb-24">
          ...
          <section className="aspect-video relative rounded-[2rem] overflow-hidden border border-white/5 shadow-2xl mb-16 bg-neutral-900 group">
            <Image 
              ...
              alt="Seamus Corry Website Redesign" 
              fill 
          ...
          <div className="grid md:grid-cols-3 gap-12 border-t border-white/5 pt-12">
            <div className="md:col-span-2 space-y-8">
              <section>
                ...
                <p className="text-white/70 italic leading-relaxed text-lg mb-4">
                  We are currently executing a comprehensive website redesign and personal branding overhaul for Seamus Corry. The goal is to elevate his digital presence to accurately reflect his premium coaching expertise.
                </p>
                <p className="text-white/70 italic leading-relaxed text-lg">
                  Full case study details, along with the implemented content strategy, will be published once the site goes live.
                </p>
              </section>
            </div>
            ...
            <div className="bg-neutral-900/50 rounded-3xl p-8 border border-white/5 h-fit">
              ...
              <ul className="space-y-4">
                {["Website Redesign", "Personal Branding", "Content Strategy"].map((service, i) => (
