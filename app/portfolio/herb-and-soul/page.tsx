...
export const metadata: Metadata = {
  ...
  description: 'Wellness brand website design and identity in progress for Herb & Soul — calm aesthetics, clear offers, and mobile-first UX.',
  alternates: {
    canonical: 'https://bear-media.com/portfolio/herb-and-soul',
  },
  openGraph: {
    url: 'https://bear-media.com/portfolio/herb-and-soul',
    title: 'Herb & Soul | Wellness Website Design | Bear Media',
    description: 'Wellness brand website design and identity in progress for Herb & Soul — calm aesthetics, clear offers, and mobile-first UX.',
    type: 'website',
    siteName: 'Bear Media',
...
const breadcrumbSchema_portfolio_herb_and_soul = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Herb & Soul",
      "item": "https://bear-media.com/portfolio/herb-and-soul"
    }
  ]
};
...
export default function HerbAndSoulCaseStudy() {
  return (
    <>
      <Script
        id="breadcrumb-schema-portfolio-herb-and-soul"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema_portfolio_herb_and_soul) }}
      />
      <Navbar />
        ...
        <article className="max-w-5xl mx-auto px-6 pb-24">
          ...
          <header className="mb-12">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div>
                <span className="inline-block px-3 py-1 bg-white/10 border border-white/20 text-white font-black uppercase tracking-widest text-[13px] md:text-sm rounded-full mb-4 mr-3">
                  Coming Soon
                </span>
                ...
                <h1 className="text-4xl md:text-7xl font-black italic uppercase font-bebas leading-[0.9] text-white">
                  Herb <span className="text-gold">& Soul</span>
                </h1>
              </div>
              <a 
          ...
          <section className="aspect-video relative rounded-[2rem] overflow-hidden border border-white/5 shadow-2xl mb-16 bg-neutral-900 group">
            <Image 
              src="/BEST FINAL CLIENT WORK/website-3-herb-soul-v2.jpg" 
              alt="Herb & Soul Website Mockup" 
              fill 
              className="object-cover opacity-50 filter-none transition-all duration-700" 
            />
            ...
            <div className="absolute inset-0 flex items-center justify-center">
               <div className="px-8 py-4 bg-neutral-950/80 backdrop-blur-md rounded-2xl border border-white/10">
                  <h2 className="text-3xl font-black italic uppercase font-bebas text-gold tracking-widest">Project In Progress</h2>
               </div>
            </div>
          </section>
            ...
            <div className="md:col-span-2 space-y-8">
              <section>
                ...
                <p className="text-white/90 italic leading-relaxed text-lg mb-4">
                  Herb & Soul is a premium wellness and lifestyle brand. We are currently developing a beautiful, immersive <Link href="/web-design" className="text-gold hover:underline">e-commerce and booking platform</Link> that perfectly aligns with their natural and holistic creative direction.
                </p>
