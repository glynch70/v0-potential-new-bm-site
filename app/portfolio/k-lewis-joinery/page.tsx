            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div>
                ...
                <h1 className="text-4xl md:text-7xl font-black italic uppercase font-bebas leading-[0.9] text-white">
                  K Lewis <span className="text-gold">Joinery</span>
                </h1>
              </div>
              <a 
            ...
            <div className="md:col-span-2 space-y-8">
              <section>
                ...
                <p className="text-white/90 italic leading-relaxed text-lg">
                  We delivered a comprehensive <Link href="/web-design" className="text-gold hover:underline">website design</Link> alongside a strong SEO foundation and tailored content creation to ensure they were visible to the right local clientele.
                </p>
              </section>
              <section>
