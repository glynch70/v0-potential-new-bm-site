...
export const metadata: Metadata = {
  title: 'Managing What Matters | Coaching Website Design | Bear Media',
  description: 'A professional website design and digital branding project for Managing What Matters, elevating their leadership coaching presence online.',
};
      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-brand-yellow selection:text-neutral-950 pt-24 md:pt-32">
        <article className="max-w-5xl mx-auto px-6 pb-24">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div>
                ...
                <h1 className="text-4xl md:text-7xl font-black italic uppercase font-bebas leading-[0.9] text-white">
                  Managing <span className="text-brand-yellow">What Matters</span>
                </h1>
              </div>
              <a 
          ...
          <section className="aspect-video relative rounded-[2rem] overflow-hidden border border-white/5 shadow-2xl mb-16 bg-neutral-900 group">
            <Image 
              src="/work/website-managing-v2.jpg" 
            ...
            <div className="md:col-span-2 space-y-8">
              <section>
                ...
                <p className="text-white/70 italic leading-relaxed text-lg mb-4">
                  Managing What Matters provides premium leadership coaching and management consultancy. They needed a clean, corporate, yet highly approachable <Link href="/web-design" className="text-brand-yellow hover:underline">website design</Link> that accurately reflected their high-level expertise.
                </p>
              </section>
              <section>
