        ...
        <section className="relative pt-24 pb-16 md:pt-48 md:pb-32 px-6 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <h1 className="text-4xl md:text-7xl font-black mb-8 leading-[0.9] tracking-tighter italic uppercase font-bebas">
              Do Estate Agents <br />
              <span className="text-gold">Need Video Content?</span>
            </h1>
           ...
           <div className="prose prose-invert prose-brand max-w-none">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-16">
                 <div className="p-8 rounded-[2rem] bg-neutral-900 border border-white/5 text-center">
                    <Video size={32} className="mx-auto mb-4 text-gold" />
                    <h4 className="text-white font-black uppercase italic font-bebas tracking-widest text-sm mb-2">Cinematic Tours</h4>
                    <p className="text-white text-xs">Premium visuals that win listings.</p>
                 </div>
                 <div className="p-8 rounded-[2rem] bg-neutral-900 border border-white/5 text-center">
                    <Users size={32} className="mx-auto mb-4 text-gold" />
                    <h4 className="text-white font-black uppercase italic font-bebas tracking-widest text-sm mb-2">Agent Authority</h4>
                    <p className="text-white text-xs">Be the face of your area.</p>
                 </div>
                 <div className="p-8 rounded-[2rem] bg-neutral-900 border border-white/5 text-center">
                    <TrendingUp size={32} className="mx-auto mb-4 text-gold" />
                    <h4 className="text-white font-black uppercase italic font-bebas tracking-widest text-sm mb-2">Lead Gen</h4>
                    <p className="text-white text-xs">Turn views into valuation calls.</p>
                 </div>
              </div>
              ...
              <p className="text-white text-lg leading-relaxed mb-8">
                 Sellers aren't just looking for someone to list their home on Rightmove. They are looking for the agent who will provide the <span className="text-gold font-bold italic">best exposure</span>. When you walk into a valuation and show them a cinematic drone tour or a high-performance social media reel of your last sale, you instantly become the premium choice.
              </p>
              ...
              <div className="p-10 rounded-[2.5rem] bg-neutral-900 border border-white/5 mb-16">
                 ...
                 <ul className="space-y-4">
                    <li className="flex gap-3 items-center text-white">
                       <CheckCircle2 className="text-gold" size={18} /> Higher engagement on social channels.
                    </li>
                    <li className="flex gap-3 items-center text-white">
                       <CheckCircle2 className="text-gold" size={18} /> Increased trust with potential sellers.
                    </li>
                    <li className="flex gap-3 items-center text-white">
                       <CheckCircle2 className="text-gold" size={18} /> Faster sales through better presentation.
                    </li>
                    <li className="flex gap-3 items-center text-white">
                       <CheckCircle2 className="text-gold" size={18} /> More high-value listings won against competitors.
                    </li>
                 </ul>
              </div>
              ...
              <Link href="/industries/estate-agents" className="inline-flex items-center gap-4 px-12 py-6 bg-gold text-neutral-950 font-black uppercase tracking-[0.2em] text-sm rounded-2xl hover:scale-105 transition-all duration-300 shadow-[0_0_60px_rgba(245,166,35,0.3)] group">
