    ...
    <>
      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-gold selection:text-neutral-950">
        ...
        <section className="relative pt-24 pb-16 md:pt-48 md:pb-40 px-6 overflow-hidden flex flex-col items-center justify-center">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            <h1 className="text-4xl md:text-8xl font-black mb-6 md:mb-8 leading-[0.9] tracking-tighter italic uppercase font-bebas">
              ...
              <span className="text-gold">Get Enquiries.</span>
            </h1>
            ...
            <div className="mt-16 pt-8 border-t border-white/5 flex flex-wrap justify-center gap-8 md:gap-16">
               ...
               <div className="flex flex-col items-center md:items-start text-center md:text-left">
                  ...
                  <p className="text-white text-[12px] md:text-[13px] font-bold uppercase tracking-widest">On-Site Filming Guarantee</p>
               </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6">
          <div className="max-w-7xl mx-auto glass-card p-12 text-center border-gold/10">
            <h2 className="text-3xl font-bold mb-6 text-gold uppercase italic font-bebas tracking-wide">The 30-Mile Promise</h2>
        ...
        <section className="py-20 px-6 bg-white/5">
          <div className="max-w-7xl mx-auto space-y-24">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
               <div>
                 <h3 className="text-3xl font-bold mb-6 text-gold italic uppercase font-bebas tracking-wide">West Lothian (Livingston, Bathgate, Broxburn)</h3>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center md:flex-row-reverse">
               <div className="md:order-2">
                 <h3 className="text-3xl font-bold mb-6 text-gold italic uppercase font-bebas tracking-wide">Edinburgh & Lothians</h3>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
               <div>
                 <h3 className="text-3xl font-bold mb-6 text-gold italic uppercase font-bebas tracking-wide">Fife & Surrounding Areas</h3>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto">
          <div className="glass-card p-12 text-center border-gold/30">
        ...
        <section className="py-32 px-6 text-center relative overflow-hidden">
           ...
           <div className="max-w-3xl mx-auto relative z-10">
              <h2 className="text-4xl md:text-6xl font-black mb-8 uppercase italic font-bebas tracking-tight text-white leading-none">
                 ...
                 <span className="text-gold underline decoration-brand-gold/30 underline-offset-8">local market?</span>
              </h2>
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-4 px-12 py-6 bg-gold text-neutral-950 font-black uppercase tracking-[0.2em] text-sm rounded-2xl hover:scale-105 transition-all duration-300 shadow-[0_0_60px_rgba(245,166,35,0.3)] group"
              >
