...
export default function EstateAgentsIndustryPage() {
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does cinematic video help sell properties?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Cinematic property tours and drone walkthroughs help sellers see the true value of their home and build trust in your agency, often leading to faster sales and higher-value listings."
        }
      },
      {
        "@type": "Question",
        "name": "What is the turnaround time for property videos?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We provide fast turnaround times, typically delivering high-impact social teasers and property tours within 24-48 hours of filming."
        }
      }
    ]
  };
      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-gold selection:text-neutral-950">
        ...
        <section className="relative pt-24 pb-16 md:pt-48 md:pb-40 px-6 overflow-hidden flex flex-col items-center justify-center">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            <h1 className="text-4xl md:text-8xl font-black mb-6 md:mb-8 leading-[0.9] tracking-tighter italic uppercase font-bebas">
              Win More Local <br />
              <span className="text-gold">Property Listings.</span>
            </h1>
            ...
            <div className="mt-16 pt-8 border-t border-white/5 flex flex-wrap justify-center gap-8 md:gap-16">
               ...
               <div className="flex flex-col items-center md:items-start text-center md:text-left">
                  ...
                  <p className="text-white text-[12px] md:text-[13px] font-bold uppercase tracking-widest">Average Monthly Growth</p>
               </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            <div className="aspect-video bg-neutral-900 rounded-2xl border border-white/5 flex items-center justify-center text-white0">
               <div className="text-center p-8 italic">Cinematic Walkthrough of a Georgian Townhouse in Edinburgh New Town</div>
            </div>
            <div>
               <h2 className="text-3xl font-bold mb-6 text-gold italic uppercase font-bebas tracking-wide">Win the Listing</h2>
               ...
               <div className="space-y-6">
                  <div className="flex gap-4 p-6 glass-card border-white/5">
                     ...
                     <div>
                        ...
                        <p className="text-white0 text-sm">Aerial perspective that highlights location and scale.</p>
                     </div>
                  </div>
                  <div className="flex gap-4 p-6 glass-card border-white/5">
                     <div className="text-gold font-bold text-xl">🎥</div>
                     <div>
                        ...
                        <p className="text-white0 text-sm">High-impact social video delivered within 24-48 hours to build immediate hype.</p>
                     </div>
                  </div>
               </div>
            </div>
        ...
        <section className="py-20 px-6 bg-white/5">
           <div className="max-w-7xl mx-auto text-center">
              ...
              <p className="text-white0 text-lg mb-12 max-w-2xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8 text-left">
                 <div className="p-10 glass-card">
                    <h4 className="text-xl font-bold mb-4 text-gold">Market Updates</h4>
                    <p className="text-white0 text-sm">Position yourself as the local market expert with high-quality vertical video updates.</p>
                 </div>
                 <div className="p-10 glass-card">
                    <h4 className="text-xl font-bold mb-4 text-gold">Behind the Scenes</h4>
                    <p className="text-white0 text-sm">Build trust by showing the hard work that goes into every sale.</p>
                 </div>
                 <div className="p-10 glass-card">
                    <h4 className="text-xl font-bold mb-4 text-gold">Agent Spotlights</h4>
                    <p className="text-white0 text-sm">Humanize your agency and build lasting relationships with sellers.</p>
                 </div>
              </div>
           </div>
        </section>
        ...
        <section className="py-24 px-6 text-center">
           <h2 className="text-3xl md:text-5xl font-black mb-8 italic uppercase font-bebas tracking-tight text-white leading-none max-w-3xl mx-auto">
              ...
              <span className="text-gold underline decoration-brand-gold/30 underline-offset-8">local property market?</span>
           </h2>
