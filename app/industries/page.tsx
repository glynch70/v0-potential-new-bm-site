    ...
    <>
      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-gold selection:text-neutral-950">
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto text-center">
          <p className="text-gold font-black uppercase tracking-[0.3em] mb-4 text-sm">Targeted Authority Systems</p>
        ...
        <section className="py-20 px-6">
          <div className="max-w-7xl mx-auto space-y-32">
            ...
            <div id="trades" className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl md:text-5xl font-black mb-6 text-gold uppercase italic font-bebas">The Tradesman's Pipeline</h2>
                ...
                <div className="space-y-4">
                   <div className="flex items-start gap-4 p-6 glass-card border-white/5">
                      <div className="text-gold font-black italic font-bebas text-3xl">01</div>
                      <div>
                   ...
                   <div className="flex items-start gap-4 p-6 glass-card border-white/5">
                      <div className="text-gold font-bold text-2xl">02</div>
                      <div>
            ...
            <div id="agents" className="grid md:grid-cols-2 gap-16 items-center md:flex-row-reverse">
              <div className="md:order-2">
                <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gold">The Agent's Edge</h2>
                ...
                <div className="space-y-4">
                   <div className="flex items-start gap-4 p-6 glass-card">
                      <div className="text-gold font-bold text-2xl">01</div>
                      <div>
            ...
            <div id="coaches" className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gold">The Scalable Coach</h2>
                <p className="text-xl text-white0 mb-8 leading-relaxed">
        ...
        <section className="py-32 px-6 text-center relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto relative z-10">
             ...
             <Link
               href="/contact"
               className="bg-gold text-neutral-950 px-12 py-6 rounded-2xl font-black uppercase tracking-widest text-sm hover:scale-105 transition-transform inline-flex items-center gap-4 shadow-[0_0_60px_rgba(245,166,35,0.3)]"
             >
