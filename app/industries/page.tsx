                ...
                <div className="space-y-4">
                   ...
                   <div className="flex items-start gap-4 p-6 glass-card border-white/5">
                      ...
                      <div>
                        ...
                        <p className="text-neutral-500 text-sm">A fast, local-SEO optimised site that wins enquiries.</p>
                      </div>
                   </div>
                </div>
              </div>
              <div className="aspect-square bg-neutral-900 rounded-2xl flex items-center justify-center text-neutral-600 border border-white/10">Trades Visual</div>
            </div>
                ...
                <div className="space-y-4">
                   <div className="flex items-start gap-4 p-6 glass-card">
                      ...
                      <div>
                        ...
                        <p className="text-neutral-500 text-sm">Perspective that sells properties faster.</p>
                      </div>
                   </div>
                   <div className="flex items-start gap-4 p-6 glass-card">
                      <div className="text-brand-yellow font-bold text-2xl">02</div>
                      <div>
                        ...
                        <p className="text-neutral-400 text-sm">High-impact video for social media to build hype.</p>
                      </div>
                   </div>
                </div>
              </div>
              <div className="aspect-square bg-neutral-900 rounded-2xl flex items-center justify-center text-neutral-600 border border-white/10 md:order-1">Agent Visual</div>
            </div>
                ...
                <div className="space-y-4">
                   <div className="flex items-start gap-4 p-6 glass-card">
                      ...
                      <div>
                        ...
                        <p className="text-neutral-500 text-sm">Consistent high-quality content that positions you as the expert.</p>
                      </div>
                   </div>
                   <div className="flex items-start gap-4 p-6 glass-card">
                      <div className="text-brand-yellow font-bold text-2xl">02</div>
                      <div>
                        ...
                        <p className="text-neutral-500 text-sm">Automated enquiry handling and lead management.</p>
                      </div>
                   </div>
                </div>
              </div>
              <div className="aspect-square bg-neutral-900 rounded-2xl flex items-center justify-center text-neutral-600 border border-white/10">SME Visual</div>
            </div>
          ...
          <div className="max-w-7xl mx-auto text-center">
             ...
             <div className="grid md:grid-cols-3 gap-8">
                <div className="p-8 glass-card text-left">
                   <p className="text-white/80 mb-4 italic text-sm">"Working with Bear Media transformed how we get leads in Livingston."</p>
                   <p className="font-bold text-brand-yellow">West Lothian Joinery</p>
                </div>
                <div className="p-8 glass-card text-left">
                   <p className="text-white/80 mb-4 italic text-sm">"The drone tours helped us win three new listings this month alone."</p>
                   <p className="font-bold text-brand-yellow">Edinburgh Estate Agency</p>
                </div>
                <div className="p-8 glass-card text-left">
                   <p className="text-white/80 mb-4 italic text-sm">"Finally, a local team that understands the Scottish market."</p>
