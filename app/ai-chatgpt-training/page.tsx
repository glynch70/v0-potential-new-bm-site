        ...
        <section className="relative pt-20 pb-24 px-6 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10 text-center">
            <h1 className="mb-6 text-4xl md:text-6xl lg:text-7xl font-black italic uppercase font-bebas leading-[0.9] tracking-tight">
              AI & ChatGPT Training <br className="hidden md:block"/> <span className="text-brand-yellow">For Teams</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
               <Link href="/contact" className="px-10 py-5 bg-brand-yellow text-neutral-950 font-black uppercase tracking-widest text-[11px] rounded-xl hover:scale-105 transition-all flex items-center justify-center gap-2">
                 <Zap size={14} className="fill-neutral-950" /> Book a Workshop
               </Link>
               <Link href="/social-media-training-scotland" className="px-10 py-5 bg-white/5 border border-white/10 text-white font-black uppercase tracking-widest text-[11px] rounded-xl hover:bg-white/10 transition-all flex items-center justify-center gap-2">
        ...
        <section className="py-24 px-6">
           <div className="max-w-5xl mx-auto">
              <div className="text-center mb-16">
                 ...
                 <p className="text-white/60 italic">We cut the theory and focus purely on practical implementation.</p>
              </div>
