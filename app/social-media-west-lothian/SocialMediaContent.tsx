      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-brand-yellow selection:text-neutral-950">
        ...
        <section className="py-32 px-6 max-w-5xl mx-auto text-center md:text-left">
           <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase italic font-bebas tracking-tight text-white leading-none">
              The Problem With <br /><span className="text-brand-yellow">"Posting Just to Post".</span>
           </h2>
        ...
        <section className="py-32 px-6 bg-neutral-900/50 border-y border-white/5">
           <div className="max-w-7xl mx-auto text-center">
              <h2 className="text-3xl md:text-5xl font-black mb-16 uppercase italic font-bebas tracking-tight text-white leading-none">
                 Our <span className="text-brand-yellow">Social Solution.</span>
              </h2>
              <div className="grid md:grid-cols-3 gap-8 text-left">
                 {[
                   { icon: <Zap className="text-brand-yellow" size={32} />, title: "Authority Reels", desc: "Short, high-impact videos that showcase your expertise and craftsmanship." },
                   { icon: <Target className="text-brand-yellow" size={32} />, title: "Local Targeting", desc: "We ensure your content is seen by potential customers in West Lothian and Edinburgh." },
                   { icon: <Users className="text-brand-yellow" size={32} />, title: "Community Trust", desc: "Consistent presence that makes you the go-to local expert in your industry." }
                 ].map((item, i) => (
        ...
        <section className="py-32 px-6 text-center">
           <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-6xl font-black mb-8 uppercase italic font-bebas tracking-tight text-white leading-none">
                 Want more enquiries from <br /> your <span className="text-brand-yellow text-underline">social media content?</span>
              </h2>
