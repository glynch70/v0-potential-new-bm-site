...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://bear-media.com/video-production-edinburgh',
  },
  openGraph: {
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Are you licensed to fly drones commercially in Edinburgh?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. We hold full CAA (Civil Aviation Authority) authorization and comprehensive commercial insurance to conduct drone flights across Edinburgh and the rest of Scotland."
      }
    },
    {
      "@type": "Question",
      "name": "Do you only work in Edinburgh?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We are based in the Central Belt and regularly provide video production across Edinburgh, Glasgow, West Lothian, Fife, and throughout Scotland."
      }
    },
    {
      "@type": "Question",
      "name": "How long does a promo video take to produce?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most projects take 2-3 weeks from filming to final delivery, though we can accommodate faster turnarounds for urgent event reels."
      }
    },
    {
      "@type": "Question",
      "name": "Can we get the raw footage?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Our standard packages include fully edited deliverables, but raw footage handovers can be arranged if required for your in-house team."
      }
    }
  ]
};
      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-gold selection:text-neutral-950">
        ...
        <div className="pt-24 pb-8 bg-neutral-950 border-b border-white/5">
           <div className="max-w-4xl mx-auto px-6 text-center">
              <p className="text-white/80 text-base md:text-lg font-medium leading-relaxed italic">
                 Bear Media provides premium video production and fully licensed drone videography for local businesses, construction sites, and events across Edinburgh and Central Scotland.
              </p>
           </div>
        </div>
        ...
        <section className="relative pt-20 pb-24 px-6 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10 text-center">
            <h1 className="mb-6 text-4xl md:text-6xl lg:text-7xl font-black italic uppercase font-bebas leading-[0.9] tracking-tight">
              Video Production & <br className="hidden md:block"/> <span className="text-gold">Drone Content in Edinburgh</span>
            </h1>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16">
             ...
             <div className="bg-neutral-950 border border-white/10 p-10 rounded-[2rem]">
                ...
                <ul className="space-y-3">
                  {["Construction & Architecture Firms (Drone Progression)", "Event Organisers & Venues (Promo Reels)", "Local Businesses & Corporates (Brand Videos)", "Real Estate & Commercial Property", "Businesses across Edinburgh & Central Scotland"].map((audience, i) => (
        ...
        <section className="py-24 px-6">
           <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                 {[
                   { title: "Licensed Drone Ops", desc: "CAA approved and insured commercial drone operations for stunning aerial perspectives." },
        ...
        <section className="py-24 px-6 max-w-4xl mx-auto">
           ...
           <div className="space-y-4">
             {[
               ...
               { q: "Do you only work in Edinburgh?", a: "We are based in the Central Belt and regularly provide video production across Edinburgh, Glasgow, West Lothian, Fife, and throughout Scotland." },
        ...
        <section className="py-24 px-6 text-center bg-gold text-neutral-950">
           <div className="max-w-3xl mx-auto">
              ...
              <p className="font-bold italic mb-10">Let's discuss your upcoming project or event.</p>
