        ...
        <section className="relative pt-20 pb-24 px-6 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10 text-center">
            <h1 className="mb-6 text-4xl md:text-6xl lg:text-7xl font-black italic uppercase font-bebas leading-[0.9] tracking-tight">
              Video Production & <br className="hidden md:block"/> <span className="text-brand-yellow">Drone Content in Edinburgh</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
               ...
               <Link href="/case-studies/dirty-martinis" className="px-10 py-5 bg-white/5 border border-white/10 text-white font-black uppercase tracking-widest text-[11px] rounded-xl hover:bg-white/10 transition-all">
                 View Our Work
               </Link>
            </div>
          </div>
        ...
        <section className="py-24 px-6">
           <div className="max-w-5xl mx-auto">
              <div className="text-center mb-16">
                 ...
                 <p className="text-white/60 italic">Fully licensed, fully insured, and highly cinematic.</p>
              </div>
        ...
        <section className="py-24 px-6 bg-brand-yellow/10 border-y border-brand-yellow/20">
           <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-black uppercase italic font-bebas tracking-tight text-brand-yellow mb-6">Cinematic Proof</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                 ...
                 <div className="bg-neutral-950 p-8 rounded-3xl border border-white/10">
                    ...
                    <Link href="/case-studies/dirty-martinis" className="inline-flex items-center gap-2 text-brand-yellow font-black uppercase tracking-widest text-[11px] hover:translate-x-1 transition-transform">
