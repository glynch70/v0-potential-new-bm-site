      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-gold selection:text-neutral-950">
        ...
        <section className="relative pt-20 pb-12 md:pt-32 md:pb-20 px-6 overflow-hidden flex flex-col items-center justify-center text-center">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              ...
              <span className="text-gold">Builds Trust and Drives Action.</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <section id="see-it-in-action" className="py-12 md:py-20 px-6 text-center max-w-7xl mx-auto">
           ...
           <div className="grid md:grid-cols-2 gap-8 items-center text-left">
              <div className="p-10 rounded-[2rem] border border-gold/20 bg-gold/[0.02]">
                 <h4 className="text-gold font-black text-8xl mb-3 font-bebas italic tracking-widest leading-none">50K+</h4>
              ...
              <div className="grid gap-4">
                 <div className="p-8 rounded-[1.5rem] border border-white/5 bg-white/[0.01]">
                    <h4 className="text-gold font-black text-4xl mb-1 font-bebas italic tracking-widest">3X</h4>
                    <p className="text-white font-bold uppercase tracking-widest text-[12px] md:text-[13px]">Trust Growth (W. Lothian Trades)</p>
                 </div>
                 <div className="p-8 rounded-[1.5rem] border border-white/5 bg-white/[0.01]">
                    <h4 className="text-gold font-black text-4xl mb-1 font-bebas italic tracking-widest">Sell Faster</h4>
                    <p className="text-white font-bold uppercase tracking-widest text-[12px] md:text-[13px]">Edinburgh Property Agents</p>
                 </div>
              </div>
           </div>
        </section>
        ...
        <section className="py-12 md:py-20 px-6 bg-neutral-900/30 border-y border-white/5">
           <div className="max-w-7xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-left">
                 {[
                   { icon: <TrendingUp className="text-gold" size={24} />, title: "Authority", desc: "Instantly look like the local leader. Justify premium pricing." },
                   { icon: <Star className="text-gold" size={24} />, title: "More Listings", desc: "Win more valuation calls and faster property sales." },
                   { icon: <Users className="text-gold" size={24} />, title: "Enquiries", desc: "We turn views into high-value discovery calls." }
                 ].map((item, i) => (
        ...
        <section className="py-12 md:py-20 px-6 max-w-7xl mx-auto">
           <h2 className="mb-12 text-center text-white text-4xl md:text-6xl font-black italic uppercase font-bebas">
              Strategic <span className="text-gold">Video.</span>
           </h2>
           <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="p-8 rounded-[2rem] bg-neutral-900 border border-white/5 group">
                   ...
                   <h3 className="text-xl font-black mb-3 uppercase italic font-bebas tracking-wide text-white group-hover:text-gold transition-colors">{item.title}</h3>
           ...
           <div className="grid md:grid-cols-3 gap-8 text-left">
              {[
                ...
                <div key={i} className="p-8 glass-card border-white/5 relative overflow-hidden group">
                   <div className="absolute -top-4 -right-4 text-7xl font-black text-white italic font-bebas group-hover:text-gold/20 transition-colors">{item.step}</div>
                   <h3 className="text-xl font-black mb-3 uppercase italic font-bebas tracking-wide text-gold">{item.title}</h3>
                   <p className="text-white text-xs italic leading-relaxed">{item.desc}</p>
                </div>
              ))}
           </div>
