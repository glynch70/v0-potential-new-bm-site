  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#0f0e0c] text-[#E8E0D5] font-inter-tight selection:bg-[#F1B92D] selection:text-[#0f0e0c] overflow-hidden">
        ...
        {/* 2. THE COST OF INACTION (DARK CINEMATIC) */}
        <section className="py-40 px-6 bg-[#0a0908] text-[#E8E0D5] relative z-10 border-b border-white/5">
          ...
          <div className="w-full px-6 md:px-12 lg:px-24 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              <div>
                <p className="text-[#F1B92D] font-bold uppercase tracking-[0.3em] text-[12px] md:text-[13px] mb-4">The Reality</p>
                <h2 className="font-bebas text-[#E8E0D5] tracking-wide uppercase leading-[0.9] mb-8">
                  THE COST OF <br/><span className="text-[#F1B92D]/85">STAYING INVISIBLE.</span>
                </h2>
                <p className="text-[#E8E0D5]/90 font-light text-base md:text-lg leading-relaxed max-w-lg mb-8">
              ...
              <div className="bg-[#171513]/40 backdrop-blur-xl p-12 border border-white/5 shadow-md rounded-sm">
                <h3 className="text-xl font-bebas tracking-wide text-red-500 mb-8 uppercase">Primary Conversion Drains</h3>
                <ul className="space-y-6">
                  {[
                    ...
                    <li key={i} className="flex gap-4 items-start text-xs text-[#E8E0D5]/90 leading-relaxed font-light">
        ...
        <section className="py-40 px-6 bg-[#0f0e0c] relative z-10 border-b border-white/5">
          ...
          <div className="w-full px-6 md:px-12 lg:px-24 relative z-10 space-y-48">
            
            {/* 1. Social Media Dominance (Dark Cinematic) */}
            <div className="grid md:grid-cols-2 gap-24 items-center">
              <div>
                <p className="text-[#F1B92D] font-bold uppercase tracking-[0.3em] text-[12px] md:text-[13px] mb-4">Command Feeds</p>
                <h3 className="font-bebas text-white uppercase tracking-wider mb-6">SOCIAL MEDIA DOMINANCE</h3>
                ...
                <Link href="/social-media" className="inline-flex items-center gap-3 text-[13px] md:text-sm font-bold uppercase tracking-[0.25em] text-[#F1B92D] hover:text-white transition-colors">
            ...
            <div className="grid md:grid-cols-2 gap-24 items-center">
              <div className="md:order-2">
                <p className="text-[#F1B92D] font-bold uppercase tracking-[0.3em] text-[12px] md:text-[13px] mb-4">Win Big Tenders</p>
                <h3 className="font-bebas text-white uppercase tracking-wider mb-6">CINEMATIC LANDSCAPE PROOF</h3>
                <p className="text-white/90 font-light text-base md:text-lg leading-relaxed mb-8">
                ...
                <Link href="/video-production" className="inline-flex items-center gap-3 text-[13px] md:text-sm font-bold uppercase tracking-[0.25em] text-[#F1B92D] hover:text-white transition-colors">
            ...
            <div className="grid md:grid-cols-2 gap-24 items-center">
              <div>
                <p className="text-[#F1B92D] font-bold uppercase tracking-[0.3em] text-[12px] md:text-[13px] mb-4">Capture Revenue</p>
                <h3 className="font-bebas text-white uppercase tracking-wider mb-6">CONVERTING SHOWROOMS</h3>
                <p className="text-white/90 font-light text-base md:text-lg leading-relaxed mb-8">
                ...
                <Link href="/web-design" className="inline-flex items-center gap-3 text-[13px] md:text-sm font-bold uppercase tracking-[0.25em] text-[#F1B92D] hover:text-white transition-colors">
                  Explore Website System <ArrowRight size={12} />
                </Link>
              </div>

              <div className="text-white/85 text-xs font-light leading-relaxed max-w-sm">
        ...
        <section className="py-48 px-6 bg-[#0a0908] text-[#E8E0D5] relative z-10 border-t border-white/5 text-center flex items-center justify-center overflow-hidden">
          ...
          <div className="w-full px-6 relative z-10 flex flex-col items-center">
            <p className="text-[#F1B92D] font-bold uppercase tracking-[0.4em] text-[12px] md:text-[13px] mb-8 font-inter-tight">Build Your Growth Engine</p>
