        ...
        <section className="relative pt-20 pb-12 md:pt-32 md:pb-20 px-6 overflow-hidden flex flex-col items-center justify-center text-center">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              ...
              <span className="text-gold">Lead-Generating Machine.</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <section id="see-it-in-action" className="py-12 md:py-20 px-6 text-center max-w-7xl mx-auto">
           ...
           <div className="grid md:grid-cols-2 gap-8 items-center mb-16 text-left">
              <div className="space-y-6">
                 ...
                 <div className="p-8 rounded-[1.5rem] bg-neutral-900 border border-gold/30 shadow-[0_0_50px_rgba(245,166,35,0.05)]">
                    <h3 className="text-gold font-black uppercase italic font-bebas tracking-widest text-lg mb-4">After: Enquiry Machine</h3>
              ...
              <div className="p-10 rounded-[2rem] border border-gold/20 bg-gold/[0.02] h-full flex flex-col justify-center">
                 <h4 className="text-gold font-black text-8xl mb-3 font-bebas italic tracking-widest leading-none">15+</h4>
        ...
        <section className="py-12 md:py-20 px-6 bg-neutral-900/30 border-y border-white/5">
           <div className="max-w-7xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-left">
                 {[
                   { icon: <MousePointer2 className="text-gold" size={24} />, title: "Qualified Leads", desc: "We don't count visitors. We count enquiries." },
                   { icon: <Star className="text-gold" size={24} />, title: "Instant Authority", desc: "Look more professional than your biggest competitor." },
                   { icon: <TrendingUp className="text-gold" size={24} />, title: "Automation", desc: "Your website fills your calendar on autopilot." }
                 ].map((item, i) => (
