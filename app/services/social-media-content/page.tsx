      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-brand-yellow selection:text-neutral-950">
        ...
        <section className="relative pt-20 pb-12 md:pt-32 md:pb-20 px-6 overflow-hidden flex flex-col items-center justify-center text-center">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              ...
              <span className="text-brand-yellow">Enquiries From Your Content.</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <section id="see-it-in-action" className="py-12 md:py-20 px-6 text-center max-w-7xl mx-auto">
           ...
           <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="p-10 rounded-[2rem] border border-brand-yellow/20 bg-brand-yellow/[0.02] text-left">
                 <h4 className="text-brand-yellow font-black text-8xl mb-3 font-bebas italic tracking-widest leading-none">400%</h4>
              ...
              <div className="grid gap-4">
                 <div className="p-8 rounded-[1.5rem] border border-white/5 bg-white/[0.01]">
                    <h4 className="text-brand-yellow font-black text-4xl mb-1 font-bebas italic">50K+</h4>
                    <p className="text-white font-bold uppercase tracking-widest text-[9px]">Local Views (Edinburgh Agent)</p>
                 </div>
                 <div className="p-8 rounded-[1.5rem] border border-white/5 bg-white/[0.01]">
                    <h4 className="text-brand-yellow font-black text-4xl mb-1 font-bebas italic">12 hrs</h4>
                    <p className="text-white font-bold uppercase tracking-widest text-[9px]">Saved Weekly (Fife SME)</p>
                 </div>
              </div>
           </div>
        </section>
        ...
        <section className="py-12 md:py-20 px-6 bg-neutral-900/30 border-y border-white/5">
           <div className="max-w-7xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-left">
                 {[
                   { icon: <TrendingUp className="text-brand-yellow" size={24} />, title: "Visibility", desc: "No more ghost towns. Stay top-of-mind every single day." },
                   { icon: <Star className="text-brand-yellow" size={24} />, title: "Instant Trust", desc: "Show them the real work. The trust gap vanishes instantly." },
                   { icon: <Users className="text-brand-yellow" size={24} />, title: "Enquiries", desc: "We focus on content that fills your calendar with jobs." }
                 ].map((item, i) => (
