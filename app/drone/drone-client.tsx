...
const droneProjects = [
  ...
  },
  {
    ...
    img: "/ATMOSPHERIC SCOTLAND IMAGES/prestonfield leaves.jpg",
    aspect: "aspect-[16/9]"
  }
]
    ...
    <>
      ...
      <main className="min-h-screen bg-[#0f0e0c] text-[#E8E0D5] font-inter-tight selection:bg-[#F1B92D] selection:text-[#0f0e0c] overflow-hidden">
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center px-6 overflow-hidden py-32 border-b border-white/5">
          <div className="absolute inset-0 bg-[#0a0908] z-0">
            <Image 
              ...
              fill 
              priority
              className="object-cover opacity-[0.25] contrast-[1.05] scale-102"
            />
        ...
        <section className="py-40 px-6 bg-[#0a0908] text-[#E8E0D5] relative z-10 border-b border-white/5">
          ...
          <div className="w-full px-6 md:px-12 lg:px-24 relative z-10 space-y-32">
            
            <div className="text-center max-w-xl mx-auto mb-20">
              <p className="text-[#F1B92D] font-bold uppercase tracking-[0.3em] text-[12px] md:text-[13px] mb-4">Atmospheric Stories</p>
              <h2 className="font-bebas text-[#E8E0D5] tracking-wide mb-6 uppercase">AERIAL CAPTURE DIRECTORY</h2>
            </div>
            ...
            {droneProjects.map((project, idx) => (
              ...
              >
                ...
                <div className={`relative ${project.aspect} w-full bg-[#0f0e0c] border border-white/5 rounded-sm overflow-hidden shadow-sm hover:border-[#F1B92D]/20 transition-all duration-500`}>
                  <Image 
                    src={project.img} 
                    alt={project.title} 
                    fill 
                ...
                <div className="grid md:grid-cols-3 gap-8 items-start">
                  <div className="md:col-span-1">
                    ...
                    <h3 className="text-4xl font-bebas text-[#E8E0D5] tracking-wider uppercase leading-none">{project.title}</h3>
                  </div>
                  <div className="md:col-span-2 text-[#E8E0D5]/90 font-light text-base md:text-lg leading-relaxed">
                    {project.desc}
                  </div>
                </div>
        ...
        <section className="py-40 px-6 bg-[#0f0e0c] relative z-10 border-b border-white/5">
          ...
          <div className="w-full px-6 md:px-12 lg:px-24 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              <div>
                <p className="text-[#F1B92D] font-bold uppercase tracking-[0.3em] text-[12px] md:text-[13px] mb-4">Central Belt Operations</p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="p-8 bg-[#171513]/40 border border-white/5 rounded-sm">
                    ...
                    <p className="text-[13px] md:text-sm text-white/85 leading-relaxed font-light">Full commercial permissions and CAA operating parameters across UK airspace.</p>
                  </div>
                  <div className="p-8 bg-[#171513]/40 border border-white/5 rounded-sm">
                    <Compass className="text-[#F1B92D] mb-4" size={20} />
                    <h4 className="text-sm font-bold uppercase tracking-wider text-white mb-2">Central Cleared</h4>
                    <p className="text-[13px] md:text-sm text-white/85 leading-relaxed font-light">Direct pre-coordinated flights inside restricted zones around major landmarks.</p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={idx} className="flex justify-between items-center border-b border-white/5 pb-4 last:border-b-0 last:pb-0">
                      <span className="text-xs text-white/90 font-light">{proto.label}</span>
                      <span className="text-[13px] md:text-sm font-bold text-[#F1B92D] uppercase tracking-wider">{proto.val}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="py-48 px-6 bg-[#0a0908] text-[#E8E0D5] relative z-10 border-t border-white/5 text-center flex items-center justify-center overflow-hidden">
          ...
          <div className="w-full px-6 relative z-10 flex flex-col items-center">
            <p className="text-[#F1B92D] font-bold uppercase tracking-[0.4em] text-[12px] md:text-[13px] mb-8 font-inter-tight">Schedule Flight Survey</p>
            <h2 className="font-bebas text-[#E8E0D5] leading-[0.9] mb-12">
              READY TO ELEVATE <br/><span className="text-[#E8E0D5]/25">YOUR BUSINESS VISUALS?</span>
            </h2>
            <Link
              href="/contact"
