      ...
      <main className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-brand-yellow selection:text-neutral-950">
        ...
        <section className="relative pt-20 pb-12 md:pt-32 md:pb-20 px-6 overflow-hidden flex flex-col items-center justify-center text-center">
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            <p className="text-brand-yellow font-black uppercase tracking-[0.3em] mb-4 text-[10px] md:text-sm animate-pulse italic">The Growth Partner Guide.</p>
            <h1 className="mb-8 text-white">
              What Does a <span className="text-brand-yellow">Creator Do?</span>
            </h1>
            <div className="glass-card p-10 border-brand-yellow/10 text-left bg-neutral-900/50">
              <h2 className="text-xl font-black mb-4 text-brand-yellow italic uppercase font-bebas tracking-widest">The Definition:</h2>
        ...
        <section className="py-12 md:py-20 px-6 max-w-7xl mx-auto border-t border-white/5">
          <div className="text-center mb-12">
             <h2 className="text-white uppercase italic font-bebas tracking-tight">Beyond the <span className="text-brand-yellow">Camera.</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="glass-card p-8 border-white/5 flex flex-col items-center text-center hover:border-brand-yellow/20 transition-all group">
                 <div className="text-brand-yellow text-4xl mb-4 font-black font-bebas italic opacity-20 group-hover:opacity-100 transition-opacity">0{i+1}</div>
                 <h4 className="text-lg font-black mb-4 italic uppercase font-bebas tracking-widest text-white">{role.title}</h4>
                 <p className="text-white text-[11px] leading-relaxed italic">"{role.desc}"</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="py-12 md:py-20 px-6 bg-neutral-900/30 border-y border-white/5">
           <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center text-left">
              <div>
                 <h2 className="text-white uppercase italic font-bebas tracking-tight mb-6">The Goal: Lead-Gen <span className="text-brand-yellow">Automation.</span></h2>
                 ...
                 <ul className="space-y-4">
                    {[
                      ...
                      <li key={i} className="flex items-center gap-3 text-white font-bold uppercase italic tracking-widest text-[10px]">
                        <span className="text-brand-yellow text-lg leading-none">⚡</span> {item}
                      </li>
                    ))}
                 </ul>
              </div>
              <div className="glass-card p-12 border-brand-yellow/10 bg-neutral-900/50 flex flex-col items-center justify-center text-center">
                 ...
                 <div className="w-12 h-1 bg-brand-yellow/20 mt-8" />
              </div>
           </div>
        </section>
