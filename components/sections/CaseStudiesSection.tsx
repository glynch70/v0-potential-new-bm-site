      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <p className="text-gold font-bold uppercase tracking-[0.3em] text-xs mb-6">
              Proven Results
            </p>
          ...
          {cases.map((study, index) => (
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-6 left-6 px-4 py-2 bg-gold text-neutral-950 text-[13px] md:text-sm font-black uppercase tracking-widest rounded-lg">
                  {study.type}
                </div>
              </div>
              ...
              <div className="p-8 flex-1 flex flex-col">
                <div className="mb-6">
                  <p className="text-white text-[13px] md:text-sm uppercase tracking-widest mb-2">The Problem</p>
                  <p className="text-white text-sm leading-relaxed">{study.problem}</p>
                </div>
                
                <div className="mb-6">
                  <p className="text-white text-[13px] md:text-sm uppercase tracking-widest mb-2">The Solution</p>
