  ...
  return (
    <section id="services" className="relative max-w-6xl mx-auto px-6 py-24 overflow-visible">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
        <div>
          <p className="text-gold font-black uppercase tracking-[0.3em] text-xs mb-4">WHAT WE DO</p>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {services.map((service, i) => (
          <div key={i} className="rounded-[2rem] p-8 bg-neutral-900/50 border border-white/5 transition-all hover:border-gold/30 hover:bg-neutral-900 group relative overflow-hidden">
            <div className="absolute top-0 right-0 w-24 h-24 bg-gold/5 blur-2xl rounded-full translate-x-12 -translate-y-12 opacity-0 group-hover:opacity-100 transition-opacity" />
            
            <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center mb-6 group-hover:bg-gold transition-colors group-hover:scale-110 duration-300">
