    ...
    backContent: (
      <div className="flex flex-col h-full">
        ...
        <div className="pt-6 border-t border-white/10 mt-auto">
          <a href="/contact" className="text-[#F1B92D] text-base font-medium hover:underline flex items-center gap-1 min-h-[44px]">
    ...
    <section id="services" className="py-24 px-4 bg-black">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-[#F1B92D] text-base font-medium uppercase tracking-widest mb-3">
