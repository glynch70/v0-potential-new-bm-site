      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-brand-yellow font-bold uppercase tracking-[0.3em] text-xs mb-6">The Service</p>
          ...
          <div className="grid sm:grid-cols-1 gap-4">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="flex items-center gap-4 p-4 bg-neutral-950/50 border border-white/5 rounded-2xl hover:border-brand-yellow/30 transition-all duration-300"
              >
