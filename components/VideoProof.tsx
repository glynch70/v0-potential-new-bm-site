        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              {stats.map((stat, i) => (
                <div key={i} className="p-6 md:p-8 rounded-3xl bg-neutral-900 border border-white/5 hover:border-brand-yellow/20 transition-all duration-300 group text-left">
                   <div className="text-brand-yellow mb-3 md:mb-4 group-hover:scale-110 transition-transform">
                      {stat.icon}
                   </div>
