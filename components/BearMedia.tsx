      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/90 backdrop-blur-sm border-b border-white/10">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex flex-col">
            ...
            <span className="text-white text-[12px] md:text-[13px] font-medium uppercase tracking-[0.15em]" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif' }}>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24">
          ...
          >
            ...
            >
              ...
              <span className="text-[#F1B92D]">Start Generating Enquiries.</span>
            </motion.h1>
            <motion.p variants={fadeUp} className="text-xl md:text-2xl text-white mb-10 md:mb-12 font-medium leading-relaxed italic max-w-xl">
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4 mb-12">
              <a
                href="#book"
                className="bg-[#F1B92D] text-black font-black uppercase tracking-widest text-sm px-10 py-5 md:px-12 md:py-6 rounded-2xl hover:scale-105 active:scale-95 transition-all duration-300 shadow-[0_0_40px_rgba(245,166,35,0.2)]"
              >
      ...
      <section id="growth" className="py-20 bg-black border-y border-white/5">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <motion.div
            ...
            variants={fadeUp}
          >
            <h2 className="text-6xl md:text-8xl font-black text-[#F1B92D] mb-4 tracking-tighter" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
              +661% Growth in 90 Days
            </h2>
            <p className="text-xl md:text-2xl text-white font-bold uppercase tracking-widest">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <motion.div
                  key={item.number}
                  variants={fadeUp}
                  className="bg-[#1a1a1a] border border-white/10 rounded-lg p-8 hover:border-[#F1B92D]/40 transition-colors"
                >
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start mb-20">
            ...
            >
              ...
              <motion.div variants={fadeUp} className="mb-12 p-8 rounded-2xl bg-white/5 border border-white/10">
                 <h3 className="text-sm font-black uppercase tracking-widest text-[#F1B92D] mb-6">What happens on the call?</h3>
              ...
              <motion.div variants={fadeUp} className="mt-12 flex items-center gap-6">
                 <div className="flex flex-col">
                    ...
                    <span className="text-[13px] md:text-sm font-bold uppercase tracking-widest text-white">Google Rating</span>
                 </div>
                 <div className="w-px h-10 bg-white/10" />
                 <div className="flex flex-col">
                    <span className="text-2xl font-black text-white italic font-bebas tracking-tight">50+</span>
                    <span className="text-[13px] md:text-sm font-bold uppercase tracking-widest text-white">Local Clients</span>
                 </div>
                 <div className="w-px h-10 bg-white/10" />
                 <div className="flex flex-col">
                    <span className="text-2xl font-black text-white italic font-bebas tracking-tight">1M+</span>
                    <span className="text-[13px] md:text-sm font-bold uppercase tracking-widest text-white">Local Views</span>
                 </div>
              </motion.div>
            </motion.div>
