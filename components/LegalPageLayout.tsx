    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0A0A0A]/90 backdrop-blur-sm border-b border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link
            href="/"
            className="text-xs uppercase tracking-wider text-white hover:text-[#D4A830] transition-colors"
          >
            Back to Home
          </Link>
        </div>
      ...
      <main className="pt-32 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-16">
            ...
            <p className="mt-4 text-sm text-white">Last updated: {lastUpdated}</p>
          </div>
