  ...
  return (
    <section className="py-16 bg-zinc-900 border-t border-zinc-800/50 overflow-hidden">
      <div className="max-w-4xl mx-auto text-center mb-10 px-4">
        <p className="text-[#D9A05B] text-sm font-bold uppercase tracking-[0.2em] mb-3">
          TRUSTED BY
        </p>
            ...
            {duplicatedClients.map((client, i) => (
              <div key={`r1-${i}`} className="flex items-center">
                <a
                  ...
                  className="bg-white/5 border border-white/10 rounded-full px-5 py-2 text-white text-sm font-medium whitespace-nowrap hover:bg-white/10 hover:border-[#D9A05B]/50 hover:text-[#D9A05B] transition-all duration-300 hover:scale-105"
                >
                  {client.name}
                </a>
