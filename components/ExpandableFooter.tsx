          ...
          {isExpanded && (
            ...
            >
              <div className="p-8 md:p-12">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm">
                      <li>
                        <a
                          href="#about"
                          className="text-white hover:text-[#C9A227] hover:translate-x-1 inline-block transition-all duration-250 ease-[cubic-bezier(0.16,1,0.3,1)]"
                        >
                          About
                        </a>
                      </li>
                ...
                <div className="mb-10 pb-8 border-b border-white/10">
                  ...
                  <div className="space-y-3 text-sm">
                    <a
                      ...
                      className="flex items-center gap-3 text-white hover:text-[#C9A227] transition-all duration-250 ease-[cubic-bezier(0.16,1,0.3,1)]"
                    >
                    ...
                    {[
                      ...
                      >
                        {org.logo ? (
                          ...
                          <span className="text-xs text-center text-white">{org.name}</span>
                        )}
                      </a>
                    ))}
                  </div>
                ...
                {/* Copyright */}
                <div className="mt-10 pt-8 border-t border-white/10 text-center text-sm text-white">
