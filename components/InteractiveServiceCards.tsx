...
const MAIN_SERVICES = [
  {
    ...
    icon: Monitor,
    title: 'Websites',
    description: 'Fast, clean websites built to convert visitors into customers. No templates. No monthly fees. You own your site outright from day one.',
    features: ['Landing pages', 'Business sites', 'Free hosting (no monthly fees)', 'You own it outright'],
    accent: '#D4A830',
